...
document.querySelector("#cards").innerHTML =
  ...
  createCard(
    ...
    createGame("switzerland", "07:00", "cameroon") +
      createGame("uruguay", "10:00", "koreaRepublic") +
  ...
  createCard(
    "27/11",
    "domingo",
    createGame("japan", "16:00", "costaRica") +
      createGame("belgium", "16:00", "morocco") +
  ...
  createCard(
    ...
    createGame("cameroon", "07:00", "serbia") +
      createGame("koreaRepublic", "10:00", "ghana") +
  ...
  createCard(
    "02/12",
    "sexta",
    createGame("koreaRepublic", "12:00", "portugal") +
...
function changeColorBlue() {
  bg.setAttribute("class", "blue")
}
function changeColorGreen() {
  bg.setAttribute("class", "green")
}
function changeColorYellow() {
  bg.setAttribute("class", "yellow")
}
